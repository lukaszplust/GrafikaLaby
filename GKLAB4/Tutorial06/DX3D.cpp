...
HRESULT InitDevice()
{
	...
	SimpleVertex vertices[] =
	{
        //1
        //(-6,-6),(-3,-6),(-3,6)
        { XMFLOAT3(-6.0f * x, -6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-3.0f *x, -6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-3.0f * x, 6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        ...
        //3
        //(-3.0),(-3,2),(0,2)
        { XMFLOAT3(-3.0f * x, 0.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-3.0f * x, 2.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f * x, 2.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        ...
        //(-3,0),(0,0),(0,2)
        { XMFLOAT3(-3.0f * x, 0.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f * x, 0.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f * x, 2.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        ...
        //(0,0),(2,2),(0,2)
        { XMFLOAT3(0.0f * x, 0.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(2.0f * x, 2.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f * x, 2.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        ...
        { XMFLOAT3(0.0f * x, 2.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(2.0f * x, 2.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(2.0f * x, 6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        ...
        //(0,2),(0,6),(2,6)
        { XMFLOAT3(0.0f * x, 2.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f * x, 6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(2.0f * x, 6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        ...
        //(0,6),(0,8),(2,6)
        { XMFLOAT3(0.0f * x, 6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f * x, 8.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(2.0f * x, 6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        ...
        //(-6,6),(-6,8),(0,8)
        { XMFLOAT3(-6.0f * x, 6.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-6.0f * x, 8.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f * x, 8.0f * x, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
...
void Render()
{
  ...
  2.0f,            0.0f,            0.0f,            1.0f
    ...
    XMFLOAT4 vLightColors2 = XMFLOAT4(0.0f, 0.5f, 0.0f, 1.0f);
	//
    ...
    // g_World2 = g_World2 * transform;
    g_World2 = XMMatrixRotationY(-t) * transform;
