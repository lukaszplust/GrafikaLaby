...
float pixels_floor[] = { //tekstura o wymiarach 2x2; dla kazdego punktu okreslone skladowe RGB koloru 
	1.0f, 0.0f, 0.0f,   0.1f, 0.5f, 0.1f,
	0.1f, 0.3f, 0.1f,   1.0f, 1.0f, 0.0f,
};

float pixels_wall[] = {
	0.7f, 0.2f, 1.0f,   0.4f, 0.9f, 0.2f,	1.0f, 0.0f, 0.1f,
	0.5f, 0.5f, 0.0f,   1.0f, 0.0f, 1.0f,	0.0f, 1.0f, 0.0f,
	0.1f, 0.0f, 1.0f,	0.5f, 0.0f, 0.0f,	0.0f, 0.5f, 0.9f
};
...
void configure_texture()
{
	...
	glGenTextures(1, &tex[2]);		// obiekt tekstury
	...
	glGenTextures(1, &tex[3]);		// obiekt tekstury
...
int main(int argc, char** argv)
{
	...
	glm::vec3 direction = glm::vec3(cos(angle), 0.0f, sin(angle)); //poczatkowy kierunek, w ktorym kamera jest skierowana
